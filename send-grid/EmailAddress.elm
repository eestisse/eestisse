...
-- This code is originally from bellroy/elm-email. I took it from Mario, who copied the implementation in order to rename it to EmailAddress, normalize the contents (toLower all the strings), and make it an opaque type.
-- Then I took out the opaque type.
-- Okay!?!?
