...
encode request =
    Json.Encode.object
        ...
        , ( "max_tokens", Json.Encode.int request.maxTokens )
        , ( "system", Json.Encode.string request.systemMessage )
        , ( "messages"
...
chatResponseDecoder : Json.Decode.Decoder (Result String Translation)
chatResponseDecoder =
...
processChatResponse : Result Http.Error String -> Result GptAssistError Translation
processChatResponse fetchResult =
    case fetchResult of
        Err httpErr ->
            case httpErr of
                Http.BadStatus 429 ->
        ...
        Ok gptResponse ->
            case Json.Decode.decodeString chatResponseDecoder gptResponse of
                Err decodeErr ->
