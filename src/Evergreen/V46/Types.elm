...
type EmailFormState
    ...
    | CodeSubmitted Evergreen.V46.EmailAddress.EmailAddress
...
type DoTranslateState
    ...
    | Error Evergreen.V46.Translation.Types.GptAssistError
...
type alias FrontendModel =
    ...
    , authFlow : Evergreen.V46.Auth.Common.Flow
    , authRedirectBaseUrl : Url.Url
    , maybeAuthedUserInfo : Maybe (Maybe FrontendUserInfo)
    , signinModel : SigninModel
    , dProfile : Maybe Evergreen.V46.Responsive.DisplayProfile
    , maybeAdminData : Maybe AdminData
    , animationTime : Time.Posix
    , backgroundModel : Maybe Evergreen.V46.Background.Types.Model
    , maybePublicCreditsInfo : Maybe PublicCreditsInfo
    , cachedTranslationRecords : Dict.Dict Int Evergreen.V46.Translation.Types.TranslationRecord
...
type alias SessionInfo =
    ...
    , redirectReturnPage : Maybe Evergreen.V46.Route.Route
    }
...
type alias BackendModel =
    ...
    , preConsentRequests : List ( Time.Posix, String, Result Evergreen.V46.Translation.Types.GptAssistError Evergreen.V46.Translation.Types.Translation )
    , translationRecords : Array.Array Evergreen.V46.Translation.Types.TranslationRecord
    , pendingAuths : Dict.Dict Lamdera.SessionId Evergreen.V46.Auth.Common.PendingAuth
    , pendingEmailAuths : Dict.Dict String Evergreen.V46.EmailCode.PendingEmailAuth
...
type FrontendMsg
    ...
    | SubmitEmailForSignin Evergreen.V46.EmailAddress.EmailAddress
    | SubmitEmailSigninCode Evergreen.V46.EmailAddress.EmailAddress String
    | Logout
    ...
    | GotoRouteAndAnimate Evergreen.V46.Route.Route
    ...
    | ToggleMobileMenu
    | FetchMoreTranslations Evergreen.V46.Translation.Types.PublicOrPersonal ( Maybe Int, Int )
...
type ToBackend
    = TB_NoOp
    | TB_AuthMsg Evergreen.V46.Auth.Common.ToBackend
    | TB_TextForTranslation Bool String
    | R_AdminData
    | R_GeneralData
    | TB_Logout
    | R_TranslationRecords Evergreen.V46.Translation.Types.PublicOrPersonal ( Maybe Int, Int )
    | R_SingleTranslationRecord Int
    | TB_SetPostAuthRedirect Evergreen.V46.Route.Route
    | R_AndClearRedirectReturnPage
    | R_EmailLoginCode Evergreen.V46.EmailAddress.EmailAddress
    | TB_EmailSigninCode Evergreen.V46.EmailAddress.EmailAddress String
...
type BackendMsg
    = B_NoOp
    | AuthBackendMsg Evergreen.V46.Auth.Common.BackendMsg
    ...
    | SubscriptionDataReceived (Result Http.Error Evergreen.V46.Stripe.Types.SubscriptionData)
    | LoginCodeEmailSentResponse ( Evergreen.V46.EmailAddress.EmailAddress, String ) (Result Http.Error Evergreen.V46.Postmark.PostmarkSendResponse)
...
type ToFrontend
    = TF_NoOp
    | TF_AuthMsg Evergreen.V46.Auth.Common.ToFrontend
    | TF_AuthSuccess FrontendUserInfo
    | TF_UserInfo (Maybe FrontendUserInfo)
    | TF_TranslationResult String (Result Evergreen.V46.Translation.Types.GptAssistError Evergreen.V46.Translation.Types.TranslationRecord)
    | TF_AdminData AdminData
    | TF_GeneralData GeneralData
    | TF_CreditsInfo PublicCreditsInfo
    | TF_TranslationRecordsRequestResult (Result TranslationRecordFetchError (List Evergreen.V46.Translation.Types.TranslationRecord))
    | TF_NoMoreTranslationsToFetch Evergreen.V46.Translation.Types.PublicOrPersonal
    | TF_RedirectReturnPage (Maybe Evergreen.V46.Route.Route)
