module Evergreen.V44.Auth.Common exposing (..)
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V44.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V44.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V44.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V44.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
