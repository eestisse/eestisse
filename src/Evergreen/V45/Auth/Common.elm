module Evergreen.V45.Auth.Common exposing (..)
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V45.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V45.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V45.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V45.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
