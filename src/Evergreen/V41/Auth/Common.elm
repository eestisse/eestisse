module Evergreen.V41.Auth.Common exposing (..)
...
type Error
    = ErrStateMismatch
    | ErrAuthorization Evergreen.V41.OAuth.AuthorizationCode.AuthorizationError
    | ErrAuthentication Evergreen.V41.OAuth.AuthorizationCode.AuthenticationError
...
type Flow
    ...
    | Authenticated Evergreen.V41.OAuth.Token
    | Done UserInfo
    | Errored Error
...
type alias Token =
    { methodId : MethodId
    , token : Evergreen.V41.OAuth.Token
    , created : Time.Posix
    , expires : Time.Posix
    }
