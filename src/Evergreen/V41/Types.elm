...
type alias FrontendModel =
    ...
    , dProfile : Maybe Evergreen.V41.Responsive.DisplayProfile
    , translationPageModel : TranslationPageModel
    , signupState : SignupState
    , maybeAdminData : Maybe AdminData
    , animationTime : Time.Posix
    , backgroundModel : Maybe Evergreen.V41.Background.Types.Model
...
type FrontendMsg
    = NoOpFrontendMsg
    | AuthSigninRequested
        { methodId : Evergreen.V41.Auth.Common.MethodId
    ...
    | GotoRoute Evergreen.V41.Route.Route
...
type ToFrontend
    ...
    | AuthSuccess Evergreen.V41.Auth.Common.UserInfo
